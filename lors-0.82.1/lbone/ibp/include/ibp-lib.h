...
extern int Socket2File(int sockfd, FILE * fp, ulong_t * size,
                       time_t pl_expireTime);
extern int File2Socket(FILE * pf_fp, int pi_sockfd, ulong_t pl_size,
                       time_t pl_expireTime);
extern int Fifo2Socket(FILE * pf_fp, int sockfd, ulong_t size,
                       ulong_t fifoSize, ulong_t pl_rdPtr, int pi_HeaderLen,
                       time_t pl_expireTime);
...
extern int Socket2Queue(int pi_sockfd,
                        ...
                        ulong_t pl_wrcount,
                        ulong_t * pl_written,
                        int pi_HeaderLen, time_t pl_expireTime);
