...
{ 
  ...
  unsigned long int  nread=0, readsize, ns=0, offset=0;   /* for new try */
  struct ibp_timer   timeout;  
  int                *targetsockets;
/*  char               mainbuff[MAXBUFFLEN];*/
  char               **targets, **ports; 
  ...
  timeout.ServerSync = 50;
  timeout.ClientTimeout = 100;
