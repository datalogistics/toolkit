/* $Id: netlib.h,v 1.1.1.1 1998/01/16 23:59:45 jhayes Exp $ */
 ...
 * Rich
 */
#define		DO_TCP_STREAM_FWD	300
#define		TCP_STREAM_RESPONSE_FWD	301
#define		TCP_STREAM_RESULTS_FWD	302

#define         DO_PING                 310
#define         PING_OK                 311
#define		DO_TIMESERIES		312
#define		TIMESERIES_OK		313
#define		DO_ROSTER		314
#define		ROSTER_OK		315
...
#define		DO_INTERFACE		404
#define		INTERFACE_OK		405
...
struct netperf_long_request_struct {
        int     request_type;
	int 	is_long;
        int  test_specific_data[MAXSPECDATA];
};
...
struct netperf_long_response_struct {
        int response_type;
	int is_long;
        int serv_errno;
        int test_specific_data[MAXSPECDATA];
...
extern  struct netperf_request_struct *netperf_long_request;
extern  struct netperf_response_struct *netperf_long_response;
