...
DLT_DEVELOPMENT_DEPS="git gcc libcurl-devel jansson-devel autoconf213 openssl-devel rpm-build rpmlint rpmdevtools make"
...
cp /vagrant/id_rsa* /var/lib/jenkins/.ssh
